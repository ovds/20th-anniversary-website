...
export default function CalendarPreview() {
    // Just show the first event since we don't have dates anymore
            ...
            <div className="bg-white rounded-3xl p-6 hover:shadow-lg transition-all cursor-pointer">
                <div className="mb-2 flex items-center gap-2">
                    ...
                    <div className="flex gap-2">
                        {firstEvent.highlights.slice(0, 2).map((highlight, i) => (
                ...
                <div className="text-xl font-bold">{firstEvent.title}</div>
            </div>
        </Link>
    );
} 